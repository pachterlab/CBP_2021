...
vals['Accuracy'] = acc_score  +  acc_score_scanvi + acc_scoreR + acc_scoreBoth + acc_scorePCA   + acc_score_2D #

r = 3
vals['Embed'] = ['LDVAE']*r + ['SCANVI']*r + ['Recon MCML']*r + ['NCA-Recon MCML']*r +['PCA 50D']*r  + ['PCA UMAP Sup.','PCA UMAP','PCA t-SNE']*r #  


# vals['Label'] = ['CellType1']*15 #+ ['Gender2']*12 + ['CellType2']*1 #+  ['CellType1'] #+  ['Gender2']
vals.to_csv('allLaMannoPreds0914.csv')
print('Made CSV')
